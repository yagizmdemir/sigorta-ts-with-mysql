...
exports.RepresentService = void 0;
var connect_1 = require("../../utils/connect");
var response_1 = require("../../utils/response");
var jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
var dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
var RepresentService = /** @class */ (function () {
    function RepresentService() {
    }
    //Başarısız olması durumunda silme yapılacak ya da ön bellekte saklanıp ona göre hepsi tekte insert atılacak.
    RepresentService.prototype.register = function (req, res, table, values, ajans) {
        return __awaiter(this, void 0, void 0, function () {
            var text;
            return __generator(this, function (_a) {
                text = "INSERT INTO ".concat(table, " SET ?");
                connect_1.mySqlConnection.query(text, values, function (err, result) {
                    var sk = process.env.JWT_SECRET;
                    if (err) {
                        if (err.code === 'ER_DUP_ENTRY') {
                            return new response_1.ResponseService(null, 'Giridiğiniz bilgiler sistemimizde kayıtlı. Lütfen giriş yapınız').error400(res);
                        }
                    ...
                    if (result.insertId) {
                        ...
                        ajans['id'] = id_1;
                        connect_1.mySqlConnection.query("INSERT INTO ajanslar SET ?", ajans, function (e, r) {
                            if (e) {
                                return new response_1.ResponseService(null, 'Server internal error!').error500(res);
                            }
                            else {
                                var atext = "UPDATE ".concat(table, " SET ajans = ? WHERE id = ?");
                                connect_1.mySqlConnection.query(atext, [r.insertId, id_1]);
                            }
                        });
    ...
    RepresentService.prototype.getAll = function (req, res, table) {
        return __awaiter(this, void 0, void 0, function () {
            var text, operation;
            return __generator(this, function (_a) {
    ...
    RepresentService.prototype.getOne = function (req, res, table, where, search) {
        return __awaiter(this, void 0, void 0, function () {
            var text, operation;
            return __generator(this, function (_a) {
    ...
    RepresentService.prototype.update = function (req, res, columns, values) {
        throw new Error('Method not implemented.');
    };
    RepresentService.prototype.addUser = function (req, res, table, values) {
        throw new Error('Method not implemented.');
    };
    RepresentService.prototype.delete = function (req, res, table, id) {
        return __awaiter(this, void 0, void 0, function () {
            var text, operation;
            return __generator(this, function (_a) {
                text = "DELETE FROM ".concat(table, " WHERE id = \"").concat(id, "\"");
                operation = connect_1.mySqlConnection.query(text, function (err, result) {
                    if (err != null)
                        return new response_1.ResponseService(null, 'Something went wrong').error400(res);
                    if (result) {
...
exports.RepresentService = RepresentService;
