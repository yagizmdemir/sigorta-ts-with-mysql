...
interface IAjans {
	...
	deleteAjans(req: Request, res: Response, table: string, id: string, values:string): Promise<void>;
    }
    ...
    export class AjansService implements IAjans {
        ...
        async getAjans(req: Request, res: Response, table: string, where: string, search: string): Promise<void> {
        ...
        async updateAjans(req: Request, res: Response, table: string, id:string, values: string, where: string): Promise<void> {
        ...
        async deleteAjans(req: Request, res: Response, table: string, id: string, values: string): Promise<void> {
