...
exports.AjansService = void 0;
var connect_1 = require("../../utils/connect");
var response_1 = require("../../utils/response");
var AjansService = /** @class */ (function () {
    function AjansService() {
    }
    AjansService.prototype.getAllajans = function (req, res, table) {
    ...
    AjansService.prototype.getAjans = function (req, res, table, where, search) {
        return __awaiter(this, void 0, void 0, function () {
            var text, operation;
            return __generator(this, function (_a) {
    ...
    AjansService.prototype.updateAjans = function (req, res, table, id, values, where) {
        return __awaiter(this, void 0, void 0, function () {
            var text, operation;
            return __generator(this, function (_a) {
                text = "UPDATE ".concat(table, " SET ").concat(id, " = ?, WHERE ").concat(where, " = ?,");
    ...
    AjansService.prototype.deleteAjans = function (req, res, table, id, values) {
        return __awaiter(this, void 0, void 0, function () {
            var text, operation;
            return __generator(this, function (_a) {
                text = "DELETE FROM ".concat(table, " WHERE ").concat(id, " = \"").concat(values, "\"");
                operation = connect_1.mySqlConnection.query(text, values, function (err, result) {
                    if (err != null)
                        return new response_1.ResponseService(null, 'Something went wrong').error400(res);
                    if (result) {
...
exports.AjansService = AjansService;
